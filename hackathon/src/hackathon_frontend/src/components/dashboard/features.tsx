...
const FeatureDashboard = () => {
    return (
        <section className="w-full my-20 p-8 md:p-20 rounded-4xl bg-gradient-to-r from-white/50 to-yellow-100/50 backdrop-blur-2xl border-gray-200/75 border-4">
            <div className="space-y-12">
                <div className="w-full flex flex-col items-center gap-4 text-[#145374]">
                    <h1 className="font-bold text-2xl md:text-3xl text-center max-w-[500px]">Key Features Designed to Elevate Your Experience</h1>
                    <p className="text-center max-w-[680px] text-xl md:text-2xl">At the heart of our platform are powerful features thoughtfully designed to enhance your experience at every step. </p>
                </div>
                <div className="overflow-hidden relative w-full h-full xl:h-[480px] bg-[#FFF0C870] rounded-4xl lg:pt-8">
                    ...
                    <article className="w-full h-full flex flex-col lg:flex-row justify-between items-center gap-24 lg:gap-0 p-4 md:p-12">
                        <div className="mt-12 lg:mt-0 relative w-full lg:w-[32%] h-full bg-linear-to-br from-[#282828]/70 to-[#808080]/70 backdrop-blur-[120px] rounded-4xl border-3 border-[#DCDCDC]">
                            ...
                            <div className="px-5 md:px-10 pt-16 text-white space-y-4">
                                <h2 className="font-bold text-2xl md:text-3xl text-[#9DD9D2]">
                        ...
                        <div className="relative w-full lg:w-[32%] h-full bg-linear-to-br from-[#282828]/70 to-[#808080]/70 backdrop-blur-[120px] rounded-4xl border-3 border-[#DCDCDC]">
                            ...
                            <div className="px-5 md:px-10 pt-16 text-white space-y-4">
                                <h2 className="font-bold text-2xl md:text-3xl text-[#FF8811]">
                                    Easy Fine Payment
                                </h2>
                                <p className="text-xl mb-12">
                        ...
                        <div className="mb-12 lg:mb-0 relative w-full lg:w-[32%] h-full bg-linear-to-br from-[#282828]/70 to-[#808080]/70 backdrop-blur-[120px] rounded-4xl border-3 border-[#DCDCDC]">
                            ...
                            <div className="px-5 md:px-10 pt-16 text-white space-y-4">
                                <h2 className="font-bold text-2xl md:text-3xl text-[#74CDFB]">
                                    Secured with ICP
                                </h2>
                                <p className="text-xl mb-12">
